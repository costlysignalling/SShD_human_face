...
GP1<-gridPar(pt.bg = "red", pt.size = 0.4, link.col = "blue", link.lwd = 1.8, link.lty = 1, out.col = "gray", out.cex = 0.1, tar.pt.bg = "black", tar.pt.size = 0.4, tar.link.col = "black", tar.link.lwd = 1.8, tar.link.lty = 1, tar.out.col = "black", tar.out.cex = 0.1, n.col.cell = 30, grid.col = "grey65", grid.lwd = 1, grid.lty = 1, txt.adj = 0.5, txt.pos = 1, txt.cex = 0.8, txt.col = "black")

coef<-1.2

# compound image

tiff("morphs_national.tiff",width=16*coef,height=28*coef,units="cm",res=600,compression="lzw")
...
tiff("morphs_national_allo.tiff",width=16*coef,height=28*coef,units="cm",res=600,compression="lzw")
...
tiff("morphs_national_nonallo.tiff",width=16*coef,height=28*coef,units="cm",res=600,compression="lzw")
...
GP2<-gridPar(pt.bg = "cyan4", pt.size = 0.4, link.col = "cyan4", link.lwd = 1.8, link.lty = 1, out.col = "cyan4", out.cex = 0.1, tar.pt.bg = "black", tar.pt.size = 0.4, tar.link.col = "black", tar.link.lwd = 1.8, tar.link.lty = 1, tar.out.col = "black", tar.out.cex = 0.1, n.col.cell = 30, grid.col = "grey55", grid.lwd = 1, grid.lty = 1, txt.adj = 0.5, txt.pos = 1, txt.cex = 0.8, txt.col = "black")
